...
#define CIRCWINDOW_START (get_options()->CircuitWindowSize)
...
#define STREAMWINDOW_START (get_options()->StreamWindowSize)
...
//mashael_N23
  ...
  uint32_t cells_fwded_n;  /* IG: this may break when it rolls over */
                           /* suggested change: in the flow control
			    * cell, give the number of cells seen _since
			    * the last flow control cell_. */
} circuit_t;
...
//mashael_N23
  ...
  uint32_t cells_fwded_p;  /* IG: this may break when it rolls over */
                           /* suggested change: in the flow control
			    * cell, give the number of cells seen _since
			    * the last flow control cell_. */
} or_circuit_t;
...
//mashael
  ...
  /** The size of the circuit window. */
  int CircuitWindowSize;

  /** The size of the stream window.  */
  int StreamWindowSize;

  /** The initial value of N3. */
  int N3Initial;

  /** The maximum value of N3. */
  int N3Max;

  /** The minimum value of N3. */
  int N3Min;

  /** The high water mark for the circuit queue. */
  int CircuitQueueHighwater;

  /** The low water mark for the circuit queue. */
  int CircuitQueueLowwater;
} or_options_t;
